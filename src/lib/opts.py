...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model', default='/home/shuanghong/Downloads/github/project/FairMOT_new_dataset/models/fairmot_dla34.pth',
                             help='path to pretrained model')
    ...
    self.parser.add_argument('--input-video', type=str,
                             default='/home/shuanghong/Downloads/github/dataset/scene/1/A/A-IMG9241-S1-f5.mov',
    ...
    #add by wsh
    self.parser.add_argument('--result_file', type=str, default='/home/shuanghong/Downloads/github/dataset/new_dataset_fair_metrics/ts-dir', help='path to test txt for evaluation')
    self.parser.add_argument('--embedding_result_filename', type=str, default='/home/shuanghong/Downloads/github/project/FairMOT_new_dataset/embedding/3/B/B.pickle', help='path to embedding')
    # opt.video_result_file
    self.parser.add_argument('--video_result_file', type=str, default='/home/shuanghong/Downloads/github/project/FairMOT_new_dataset/video_result', help='path to videoresult')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/home/shuanghong/Downloads/github/dataset')
