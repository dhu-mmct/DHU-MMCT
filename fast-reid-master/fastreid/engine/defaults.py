...
def default_argument_parser():
    ...
    parser.add_argument('--a', type=str, default = '',help='')
    parser.add_argument('--b', type=str, default = '',help='')
    parser.add_argument('--c', type=str, default = '',help='')
    parser.add_argument('--embedding_result_filename_A', type=str, default = '',help='')
    parser.add_argument('--embedding_result_filename_B', type=str, default = '',help='')
    parser.add_argument('--embedding_result_filename_C', type=str, default = '',help='')
    parser.add_argument('--crop_dir', type=str, default = '/home/shuanghong/Downloads/github/project/FairMOT_new_dataset/crop_reid',help='')
